...
describe("calculateOpponentHeaderCollapseState", () => {
  it("preserves expanded, intermediate, compact, and reduced-motion states", () => {
    ...
    expect(intermediate).toMatchObject({ rawProgress: 0.5, progress: 0.5, remaining: 0.5, backdropOpacity: 0.75, avatarTranslateY: -70, nameTranslateY: -63.5, scoreTranslateY: -69.5, scoreFontWeight: 500, summaryTranslateY: -40 });
    ...
    expect(compact).toMatchObject({ rawProgress: 1, progress: 1, remaining: 0, backdropOpacity: 1, avatarTranslateY: -140, avatarScale: 0.45, nameTranslateY: -127, nameScale: 0.7142857, scoreTranslateY: -139, scoreScale: 0.3125, scoreFontWeight: 400, summaryOpacity: 0, summaryTranslateY: -80 });
